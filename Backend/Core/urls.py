...
urlpatterns = [
    path('',ratelimit(key='ip', method='GET', rate='10/m')                                          (views.home), name='home'),
    path('cadastro_cliente',ratelimit(key='ip', method='GET', rate='10/m')                          (views.cadastro_cliente),name='cadastro_cliente'),
    path('historico-compras/<int:cliente_id>/',ratelimit(key='ip', method='GET', rate='10/m')       (views.historico_compras), name='historico_compras'),
    path('fechar_card/',ratelimit(key='ip', method='GET', rate='10/m')                              (views.fechar_card), name='fechar_card'),
    path('clientes',ratelimit(key='ip', method='GET', rate='10/m')                                  (views.clientes),name='clientes'),
    path('cliente/<int:id>',ratelimit(key='ip', method='GET', rate='10/m')                          (views.Cliente),name='cliente'),
    path('avaliar_cliente/<int:id>',ratelimit(key='ip', method='GET', rate='10/m')                  (views.avaliar_cliente), name='avaliar_cliente'),
    path('Edita_cliente/<int:id>',ratelimit(key='ip', method='GET', rate='10/m')                    (views.Edita_cliente),name='Edita_cliente'),
    path('excluir_cliente/<int:id>',ratelimit(key='ip', method='GET', rate='10/m')                  (views.excluir_cliente),name='excluir_cliente'),
    path('Lista_Os',ratelimit(key='ip', method='GET', rate='10/m')                                  (views.Lista_Os),name='Lista_Os'),
    path('Cadastrar_os/<int:id_cliente>',ratelimit(key='ip', method='GET', rate='10/m')             (views.Cadastrar_os),name='Cadastrar_os'),
    path('ordens_pendentes/',ratelimit(key='ip', method='GET', rate='10/m')                         (views.ordens_faltando_pagamento), name='ordens_pendentes'),
    path('pagar_parcela/<int:parcela_id>/', ratelimit(key='ip', method='GET', rate='10/m')          (views.pagar_parcela), name='pagar_parcela'),
    path('Visualizar_os/<int:id_os>',ratelimit(key='ip', method='GET', rate='10/m')                 (views.Visualizar_os),name='Visualizar_os'),
    path('emitir_nfe/<int:id_os>',ratelimit(key='ip', method='GET', rate='10/m')                    (views.emitir_nfe_view),name='emitir_nfe'),
    path('Editar_os/<int:id_os>',ratelimit(key='ip', method='GET', rate='10/m')                     (views.Editar_os),name='Editar_os'),
    path('Encerrar_os/<int:id_os>',ratelimit(key='ip', method='GET', rate='10/m')                   (views.Encerrar_os),name='Encerrar_os'),
    path('Cancelar_os/<int:id_os>',ratelimit(key='ip', method='GET', rate='10/m')                   (views.Cancelar_os),name='Cancelar_os'),
    path('Laboratorio_os/<int:id_os>',ratelimit(key='ip', method='GET', rate='10/m')                (views.Laboratorio_os),name='Laboratorio_os'),
    path('Loja_os/<int:id_os>',ratelimit(key='ip', method='GET', rate='10/m')                       (views.Loja_os),name='Loja_os'),
    path('Finalizar_os/<int:id_os>',ratelimit(key='ip', method='GET', rate='10/m')                  (views.Finalizar_os),name='Finalizar_os'),
    path('view_history/<int:id>',ratelimit(key='ip', method='GET', rate='10/m')                     (views.view_history), name='view_history'),
    path('Imprimir_os/<int:id_os>',ratelimit(key='ip', method='GET', rate='10/m')                   (Imprimir_os), name='Imprimir_os'),
    path('gerar_carner_pdf/<int:ordem_id>',ratelimit(key='ip', method='GET', rate='10/m')           (gerar_carner_pdf), name='gerar_carner_pdf'),
    path('export_clientes',ratelimit(key='ip', method='GET', rate='10/m')                           (export_clientes),name='export_clientes'),
    path('export_os',ratelimit(key='ip', method='GET', rate='10/m')                                 (export_os),name='export_os'),
    path('Dashabord',ratelimit(key='ip', method='GET', rate='10/m')                                 (views.Dashabord),name='Dashabord'),
    path('update_card_status/<int:card_id>', ratelimit(key='ip', method='GET', rate='10/m')         (views.update_card_status), name='update_card_status'),
    path('Caixa',ratelimit(key='ip', method='GET', rate='10/m')                                     (views.Caixa), name='Caixa'),
    path('abrir_caixa/', ratelimit(key='ip', method='GET', rate='10/m')                             (views.abrir_caixa), name='abrir_caixa'),
    path('fechar_caixa',ratelimit(key='ip', method='GET', rate='10/m')                              (views.fechar_caixa), name='fechar_caixa'),
    path('cadastro_caixa',ratelimit(key='ip', method='GET', rate='10/m')                            (views.cadastro_caixa), name='cadastro_caixa'),
    path('vendas_lentes',ratelimit(key='ip', method= 'GET', rate= '10/m')                           (views.vendas_lentes), name='vendas_lentes'),
