...
urlpatterns = [
    ...
    path('pagar_parcela/<int:parcela_id>/',         (views.pagar_parcela), name='pagar_parcela'),
...
htmx_patterns =[
    ...
    path('search_by_city/',htmx_views.search_by_city,name='search_by_city'),
    path('search_by_lentes/',htmx_views.search_by_lentes,name='search_by_lentes'),
